...
function drawGrid(polygon,side,pad,map){
	...
	var eastcoord = Math.max.apply(Math,polygon.map(function(o){return Math.abs(o.lng);}));
	var westcoord = Math.min.apply(Math,polygon.map(function(o){return Math.abs(o.lng);}));
